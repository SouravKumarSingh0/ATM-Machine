...
#include<iostream> // taking user input and showing output
#include<string>
using namespace std;
/*Project - ATM
-> Check Balance
...
int main()
{
	...
	user1.setData(123456789, "Sourav", 1111, 100000.50, "8210226328");
	do
	{
		system("cls");
		...
		cout << endl << "Enter Your PIN ";				 // asking user to enter PIN
		cin >> enterPIN;
